...
public class Vector3D {
    ...
    public static double calculateDistance(Vector3D vectorA, Vector3D vectorB){
        return Math.sqrt(Math.pow(vectorA.getX()-vectorB.getX(), 2) + Math.pow(vectorA.getY()-vectorB.getY(), 2) + Math.pow(vectorA.getY()-vectorB.getY(), 2));
    }
